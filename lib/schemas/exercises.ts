...
export const generatedExerciseSchema = z.object({
  ...
  tags: z
    .array(z.string())
    .describe(
      "Lista de 3-5 etiquetas relevantes en español que categoricen el ejercicio. Usar términos como: 'memoria', 'atención', 'cognitivo', 'visual', 'espacial', 'secuencia', 'números', 'colores', 'tiempo de reacción', 'foco', 'memoria de trabajo', etc."
    ),
  thumbnailPrompt: z
    .string()
    .describe(
